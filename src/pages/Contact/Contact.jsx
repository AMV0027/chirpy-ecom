      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <img
              src="/logo.png"
              alt="CHIRPY - Your Furniture Tales"
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Have questions about our furniture collection? Need assistance with your order?
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@chirpy.com</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">Do you offer assembly services?</h4>
                  <p className="text-sm text-gray-600">Yes, we offer professional assembly services for an additional fee.</p>
                </div>
              </CardContent>
            </Card>
          </div>
